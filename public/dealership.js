...
dealership[ "useMultisigAsBuyer" ] = async sig2 => {
    ...
    var i_am_buyer = true;
    return dealership.settleContract(privkey, pubkey1, pubkey2, index, destino, from_amount, to_amount, timelock, sig2, preimage, hash, txid, vout, i_am_buyer, null, true);
}
